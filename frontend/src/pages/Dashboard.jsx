                                    ...
                                    recentSales.map((sale, idx) => (
                                        <div key={idx} className="flex items-center justify-between pb-4 border-b border-[#27272a] last:border-0 last:pb-0">
                                            ...
                                            <div className="text-right">
                                                <div className="font-bold text-sm block min-w-[60px] text-right">${sale.total || '0'}</div>
                                            </div>
                                        </div>
                                    ))
                                )}
                                ...
                                {recentPurchases.length === 0 ? (
                                    ...
                                    recentPurchases.map((purchase, idx) => (
                                        <div key={idx} className="flex items-center justify-between pb-4 border-b border-[#27272a] last:border-0 last:pb-0">
                                            ...
                                            <div className="text-right">
                                                <div className="font-bold text-sm block min-w-[60px] text-right">${purchase.total || '0'}</div>
                                            </div>
                                        </div>
                                    ))
                                )}
